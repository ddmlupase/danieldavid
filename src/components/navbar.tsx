...
export default function Navbar() {
 return (
   <nav className="flex flex-col sm:flex-row justify-between items-center py-10 gap-6 sm:gap-0">
     {/* Logo / Name */}
     <h1 className="text-3xl font-black font-reddit-sans text-[#222222] flex gap-2">
       danieldavid
     </h1>

     {/* Nav Links */}
     <ul className="flex flex-wrap justify-center sm:justify-end gap-6 sm:gap-14 text-[#222222] font-normal text-sm sm:text-base font-reddit-sans">
       <li>
         <Link
           href="/"
